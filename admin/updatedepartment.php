...
if($_SESSION["is_login"]=="" or !isset($_SESSION['is_login']))
 {
    header("location:index.php");
        ...
        if($_SERVER['REQUEST_METHOD']=='POST')
        {
            ...
            $sql="update department_tbl set deptname='".$deptname."' where deptid='".$deptid."'";
            mysqli_query($con,$sql);
			header("location:viewdepartment.php");
            
        }
        $sql="select * from department_tbl where deptid='".$deptid."'";
  ...
  <br/>     
   ...
   <div class="control-group success">
              <label class="control-label" for="inputError"><strong>Department Name</strong></label>
                 <div class="controls">
                    <input type="text" id="inputError" name="deptname" value="<?php echo $d['deptname'];?>">
                 </div>
        </div>
