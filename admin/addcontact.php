...
$cphoneno=$_REQUEST['phnno'];

$sql="insert into contact_tbl values(NULL,'".$cname."','".$caddress."', '".$cemail."', '".$cphoneno."')";
...
<!========================================Form=========================================================>           <br/>     
 ...
 <div class="control-group success">
              <label class="control-label" for="inputError"><strong>Conatact Address</strong></label>
                 <div class="controls">
	   ...
	   <div class="control-group success">
              <label class="control-label" for="inputError"><strong>Conatact Email-ID</strong></label>
                 <div class="controls">
		...
		<div class="control-group success">
              <label class="control-label" for="inputError"><strong>Conatact Phone-Number</strong></label>
                 <div class="controls">
                    <input class="input-xlarge focused" id="focusedInput" type="text" name="phnno">
                 </div>
        </div> 			
